            ...
            <div class="modal-body">
                <form id="formCreate" name="formCreate" class="form-horizontal">
                    ...
                    <input type="hidden" name="id" id="id">
                        <div class="position-relative row form-group"><label class="col-sm-3 col-form-label" for="barang_id">Supplier</label>
                            <div class="col-sm-9">
                        ...
                        <div class="position-relative row form-group"><label class="col-sm-3 col-form-label" for="tanggal">Nama barang</label>
                            <div class="col-sm-9"><input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="Masukan Nama" value="" maxlength="50" required="">
                                </div>
                        </div>
                        <div class="position-relative row form-group"><label class="col-sm-3 col-form-label" for="jumlah">jumlah</label>
                            <div class="col-sm-9"><input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Masukan No Telepon" value="" maxlength="50" required="">
                                </div>
                        </div>
                    </div>
            </div>
